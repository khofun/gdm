...
class GaragesControllerTest < ActionController::TestCase
  ...
  test "should create garage" do
    assert_difference('Garage.count') do
      post :create, garage: { location: @garage.location, master_code: @garage.master_code, name: @garage.name, state: @garage.state }
    end
  ...
  test "should update garage" do
    patch :update, id: @garage, garage: { location: @garage.location, master_code: @garage.master_code, name: @garage.name, state: @garage.state }
    assert_redirected_to garage_path(assigns(:garage))
  end
